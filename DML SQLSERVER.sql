...
VALUES	(1, 'EMI', 'Rod. Dutra, km. 29,8', 55659856, 89657894, 'emi@emi-musica.com.br'),
		(2, 'Polygram', 'Rod. Imigrantes, km. 29,8', 99659856, 75957894, 'polygram@musica.com.br'),
		(3, 'BMG', 'Rod. Anchieta, km. 289,8', 99654456, 75957004, 'bmg@musica.com.br'),
		(4, 'Som Livre', 'Av. São José, km. 289,8', 99657806, 78957004, 'somlivre@musica.com.br'),
		(5, 'EPIC', 'Av. Alda, nº 89', 58793321, 89654789, 'epic@musica.com.br');
go
...
--Para inserir na sequência de colunas que eu quero
...
ALTER TABLE faixa
DROP CONSTRAINT PK__faixa__6B603B316F21B8F1;
go
